      ...
      <div className="instr-container">
        ...
        <div className="instr-title-row">
          ...
          <button className="instr-link" type="button" aria-label="Подробная инструкция">
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M4.875 5.625C4.875 5.21079 5.21079 4.875 5.625 4.875H12.375C12.7892 4.875 13.125 5.21079 13.125 5.625V12.375C13.125 12.7892 12.7892 13.125 12.375 13.125C11.9608 13.125 11.625 12.7892 11.625 12.375V7.43566L6.53033 12.5303C6.23744 12.8232 5.76256 12.8232 5.46967 12.5303C5.17678 12.2374 5.17678 11.7626 5.46967 11.4697L10.5643 6.375H5.625C5.21079 6.375 4.875 6.03921 4.875 5.625Z" fill="#C8DEFA" fillOpacity="0.44"/>
            </svg>
          </button>
        </div>
